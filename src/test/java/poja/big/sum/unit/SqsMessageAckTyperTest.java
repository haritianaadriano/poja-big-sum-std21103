...
import poja.big.sum.endpoint.event.EventConsumer;
import poja.big.sum.endpoint.event.gen.UuidCreated;
...
public class SqsMessageAckTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent("poja.big.sum.endpoint.event.gen.UuidCreated", payload);
